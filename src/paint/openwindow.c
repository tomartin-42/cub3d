...
/*   Updated: 2021/12/21 08:49:09 by tomartin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	win->text[0].img = mlx_png_file_to_image(win->mlx, mapi->NO_rute,
			&(win->text[0].width), &(win->text[0].height));
	win->text[1].img = mlx_png_file_to_image(win->mlx, mapi->EA_rute,
			&(win->text[1].width), &(win->text[1].height));
	win->text[2].img = mlx_png_file_to_image(win->mlx, mapi->SO_rute,
			&(win->text[2].width), &(win->text[2].height));
	win->text[3].img = mlx_png_file_to_image(win->mlx, mapi->WE_rute,
